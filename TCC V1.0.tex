...
Após a instalação ser concluída, o terminal irá mostrar o endereço de acesso ao Nessus, por exemplo http://kali:8834/, no qual deverá entrar com o código de ativação recebido anteriormente.
% ----------------------------------------------------------
% PARTE
% ----------------------------------------------------------
\part{Testes}
