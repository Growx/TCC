...
Após verificação das falhas de segurança, serão apresentadas possíveis soluções para o problema em questão, assim como possíveis modos para explorar essas falhas.
As falhas serão classificas conforme o dano que pode ser causado ao sistema.
...
\section{Possíveis soluções para os problemas}

\section{Explorando as falhas}
% ---
