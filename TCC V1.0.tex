...
\\Para iniciar o serviço do Nessus, basta executar no terminal o comando: \textbf{service nessusd start}. Após a execução basta acessar o endereço que foi dado e entrar com o código de ativação. Será executado a compilação de todos os \textit{plugins} utilizados pela ferramenta.
% ----------------------------------------------------------
% PARTE
% ----------------------------------------------------------
\part{Testes}
